...
void WebViewOverlay::_draw_placeholder() {
  ...
  font->draw_string(get_canvas_item(),
                    Vector2((size.x - url_size.x) / 2, 100 + url_size.y) +
                        Vector2(1, 1),
                    home_url, HALIGN_LEFT, -1, font_size, Color(0, 0, 0, 0.5));
  font->draw_string(get_canvas_item(),
                    Vector2((size.x - url_size.x) / 2, 100 + url_size.y) +
                        Vector2(-1, 1),
                    home_url, HALIGN_LEFT, -1, font_size, Color(0, 0, 0, 0.5));
  ...
  font->draw_string(get_canvas_item(),
                    Vector2((size.x - url_size.x) / 2, 100 + url_size.y),
                    home_url, HALIGN_LEFT, -1, font_size, Color(1, 1, 1));
}
...
void WebViewOverlay::_draw_error(const String &p_error) {
  ...
  font->draw_string(get_canvas_item(),
                    Vector2((size.x - ti_size.x) / 2, 100 + ti_size.y) +
                        Vector2(1, 1),
                    err_ti, HALIGN_LEFT, -1, font_size, Color(0, 0, 0, 0.5));
  font->draw_string(get_canvas_item(),
                    Vector2((size.x - ti_size.x) / 2, 100 + ti_size.y) +
                        Vector2(-1, 1),
                    err_ti, HALIGN_LEFT, -1, font_size, Color(0, 0, 0, 0.5));
  ...
  font->draw_string(get_canvas_item(),
                    ...
                    HALIGN_LEFT, -1, font_size, Color(1, 0, 0));

  font->draw_string(
      get_canvas_item(),
      Vector2((size.x - er_size.x) / 2, 100 + er_size.y + 10 + ti_size.y) +
          Vector2(1, 1),
      p_error, HALIGN_LEFT, -1, font_size, Color(0, 0, 0, 0.5));
  font->draw_string(
      get_canvas_item(),
      Vector2((size.x - er_size.x) / 2, 100 + er_size.y + 10 + ti_size.y) +
          Vector2(-1, 1),
  ...
  font->draw_string(
      get_canvas_item(),
      Vector2((size.x - er_size.x) / 2, 100 + er_size.y + 10 + ti_size.y),
      p_error, HALIGN_LEFT, -1, font_size, Color(1, 0, 0));
}
